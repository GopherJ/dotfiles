...
alias o="open"
alias c='pbcopy'
alias rg="rg --ignore-case --hidden --iglob '!**/out' --iglob '!**/heiko.json' --iglob '!**/parallel.json' --iglob '!**/*.svg' --iglob '!**/*.min.js' --iglob '!**/*.umd.js' --iglob '!**/*.common.js' --iglob '!**/.cache' --iglob '!**/package-lock.json' --iglob '!**/Cargo.lock' --iglob '!**/.git/**' --iglob '!**/dist' --iglob '!**/.yarn' --iglob '!**/build' --iglob '!**/yarn.lock' --iglob '!**/*.min.js' --iglob '!**/*.min.css'"
alias h="history -n"
...
# export PATH="$CARGO_HOME/bin:$GOENV_ROOT/bin:$LLVM_DIR/bin:$COREUTILS_BIN_DIR:$GNU_TAR_BIN_DIR:$DENO_INSTALL/bin:$FLUTTER_HOME/bin:$DART_HOME/bin:$PUB_HOME/bin:$ANDROID_HOME/tools/bin:$ANDROID_HOME/tools:$ANDROID_HOME/emulator:$GOENV_ROOT/bin:$SCRIPT_HOME:$PATH"
export PATH="$CARGO_HOME/bin:$GOENV_ROOT/bin:$GCLOUD_SDK_DIR/bin:$LLVM_DIR/bin:$COREUTILS_BIN_DIR:$GNU_TAR_BIN_DIR:$GOENV_ROOT/bin:$SCRIPT_HOME:$PATH"
